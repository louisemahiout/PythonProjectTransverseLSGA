...
def run_game():
    ...
    jump_velocity = -7 # Vitesse du saut (doublée)
    gravity = 0.4  # Gravité du personnage
    ...
    # Définir le terrain avec hitboxes, ajusté à la hauteur de 400
    terrain = [
        pygame.Rect(0, screen_height - 20, 5000, 20),  # Sol de base (reste en bas)
        pygame.Rect(500, 400, 100, 20),  # Plateforme 1 à y = 400
        pygame.Rect(700, 350, 100, 20),  # Plateforme 2 à y = 350
        pygame.Rect(1700, 300, 100, 20),  # Plateforme 3 à y = 300
        pygame.Rect(1900, 250, 100, 20),  # Plateforme 4 à y = 250
        pygame.Rect(2100, 200, 100, 20),  # Plateforme 5 à y = 200
        pygame.Rect(2800, 150, 100, 20),  # Plateforme 6 à y = 150
        pygame.Rect(3000, 100, 100, 20),  # Plateforme 7 à y = 100
    ]
    ...
    run = True
    while run:
        clock.tick(50)  # Framerate (images par seconde)
        ...
        background_width = background.get_width()  # Largeur du fond (385 px dans ton cas)
        for i in range((
                               screen_width + background_width) // background_width + 1):  # Défilement en fonction de la largeur du fond
            x_bg = i * background_width - (scroll_x % background_width)  # Défilement horizontal
            screen.blit(background, (x_bg, 0))  # Placer l'image de fond sans inverser
